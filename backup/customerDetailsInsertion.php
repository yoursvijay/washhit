...
session_start();
$conn = new mysqli("localhost","dlyncusr","digital@9","dltest");
   // Check connection
...
$headers .= 'From:Bookings@washhit.com';
 $authKey = "281348AYZyS7R5FLv5d36e06e";
         $senderId = "WASHIT";
         $_SESSION['phoneNumber']=$phoneNumber;
        $mobileNumber=$_SESSION['phoneNumber'];
        $messagesms ='Thanks for choosing WASHHIT your slot has been booked';
...
// Compose a simple HTML email message
                    ...
                    while ($row=mysqli_fetch_array($result)){
                         $id=$row[0];
                         $messageadminsms ="Userid: WI00$id  UserId: $email  TimeSlot: $time  BookedDate: $datepicker  Address: $landmark";
$message = '  <div style="margin: 0;
 ...
 $sql = "INSERT INTO customers(name,phonenumber,email,datepicker,time,select_area,housenumber,address,landmark,pincode)
     VALUES ('$name','$phoneNumber','$email','$datepicker', '$time', '$select','$houseNumber', '$address','$landmark','$pincode')";
     if($conn->query($sql)){
         echo "success";
